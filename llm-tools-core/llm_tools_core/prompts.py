...
def build_simple_system_prompt(include_datetime: bool = True) -> str:
    ...
    base_prompt = (
        ...
        "You MUST provide a complete, self-contained answer in a SINGLE response turn. The user cannot reply back.\n"
        "Do NOT ask the user ANY questions — not for clarification, not for preferences, not for next steps, not even rhetorical questions.\n"
        ...
        "If multiple approaches exist, briefly list them with your recommended one — do NOT ask the user to choose.\n\n"
